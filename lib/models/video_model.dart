class VideoModel {  
  ...
  factory VideoModel.fromJson(Map<String, dynamic> json, String avatarUrl) => VideoModel(  
        kind: json["kind"],  
        etag: json["etag"],  
        id: Id.fromJson(json["id"]),  
        snippet: Snippet.fromJson(json["snippet"]),  
        duration: json["duration"] ??'', // Asegúrate de que el JSON contenga esta clave  
        viewCount: json["viewCount"] != null ? json["viewCount"].toString() : '', // Asegúrate de que el JSON contenga esta clave  
