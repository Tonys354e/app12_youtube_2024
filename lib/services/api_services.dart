...
class APIService {
  Future<List<VideoModel>> getVideos() async {
    ...
    String path =
        "https://youtube.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyD5vXtKXP98jRwTlnLafnqkKVeS7NVuzRE&maxResults=20&regionCode=JP";
  ...
  Future<VideoModel> fetchVideoDetails(String videoId, String channelId) async {
    final response = await http.get(
      Uri.parse('https://www.googleapis.com/youtube/v3/videos?part=snippet,contentDetails,statistics&id=$videoId&key=AIzaSyD5vXtKXP98jRwTlnLafnqkKVeS7NVuzRE'),
    );
  ...
  Future<String> fetchChannelAvatar(String channelId) async {
    final response = await http.get(
      Uri.parse('https://www.googleapis.com/youtube/v3/channels?part=snippet&id=$channelId&key=AIzaSyD5vXtKXP98jRwTlnLafnqkKVeS7NVuzRE'), 
    );
